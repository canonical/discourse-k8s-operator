...
1.  **Quadrant Introduction (1-2 sentences):** Write a high-level overview of the category's domain value, then ground it by summarizing the journey the user will follow through the current sections -- framing the technical outcomes in terms of the section themes rather than listing individual file titles.
    ...
    * *Example:* "Manage the operational lifecycle of your Discourse deployment, from initial provisioning and service configuration through to ongoing maintenance and contribution workflows."
