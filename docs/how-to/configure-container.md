...
* Throttle level protections provided by Discourse can be changed using [`throttle_level`](https://charmhub.io/discourse-k8s/configure#throttle_level)
